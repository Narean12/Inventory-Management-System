        ...
        <div className="header-content">
          ...
          <div className="header-left">
            ...
            <div className="nav-links">
              ...
              <Link to="/products-non-admin" className={`nav-link ${isActive('/products-non-admin') ? 'active' : ''}`}>
                Products
              </Link>
              <Link to="/profile-non-admin" className={`nav-link ${isActive('/profile-non-admin') ? 'active' : ''}`}>
                Profile
              </Link>
            </div>
          </div>
          ...
          <div className="header-right">
            ...
            <button className="icon-button" onClick={() => navigate('/profile-non-admin')}>
